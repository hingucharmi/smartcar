    ...
    setTimeout(() => {
      ...
      if (newRecord) {
        newRecord.addEventListener('click', function () {
          ...
          (offCanvasElement.querySelector('.dt-avenues-name').value = ''),
            // (offCanvasElement.querySelector('.dt-post').value = ''),
            (offCanvasElement.querySelector('.dt-name').value = ''),
            (offCanvasElement.querySelector('.dt-plan').value = ''),
            (offCanvasElement.querySelector('.dt-solt-price').value = '');
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#addNewZones">Add New Records</span>',
    ...
    $('div.head-label').html('<h5 class="card-title mb-0"> Details</h5>');
  }
