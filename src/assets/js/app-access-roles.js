      ...
      buttons: [
        {
          ...
          text: '<i class="ti ti-upload ti-xs me-sm-1 align-text-bottom"></i> <span class="d-none d-sm-inline-block"></span>',
          buttons: [
            {
              extend: 'print',
                ...
                format: {
                  body: function (inner, coldex, rowdex) {
                    ...
                    $.each(el, function (index, item) {
                      if (item.classList !== undefined && item.classList.contains('full_name')) {
