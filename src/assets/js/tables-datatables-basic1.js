...
$(function () {
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      "ajax": {
            // "url": "/avenues/list/ajax/",  // Ensure this Django URL is correct
            "type": "GET"},
      "columns": [
            ...
            { data: 'id' },
            { data : "avenues_name" },
            { data : "avenues_username" },
            { data : "avenues_email" },
            { data  : "avenues_address" },
            { data  : "avenues_slot_price" },
            { data  : "avenues_logo" },
            { data  : "avenues_country" },
            { data  : "avenues_state" },
            { data  : "avenues_city" },
            { data  : "avenues_pincode" },
            { data  : "" } ,
            { data: "" },
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function (e, dt, button, config) {
           window.location.href = '/avenues/add';}
