...
//   console.log("Checking table:", $(".datatables-basic"));
// console.log("Table length:", $("#.datatables-basic").length);
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      "ajax": {
            "url": "/floors/list/",  // Ensure this Django URL is correct
            "type": "GET"},
      "columns": [
  ...
  fv.on('core.form.valid', function () {
    var $new_avenuesname = $('.add-new-record .dt-avenues-name').val(),
      $new_floorname = $('.add-new-record .dt-floors-name').val(),
      $new_plan = $('.add-new-record .dt-floors-plan').val(),
      $new_slotprice = $('.add-new-record .dt-floors-solt-price').val()
    ...
    if ($new_name != '') {
      dt_basic.row
        .add({
          id: count,
          avenues_name: $new_avenuesname,
          floors_name: $new_floorname,
          floors_solt_price: $new_slotprice,
          floors_plan: $new_plan,
          salary: '$' + $new_salary,
          status: 5
        })
        .draw();
