  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#addNewcustomers">Add New Records</span>',
