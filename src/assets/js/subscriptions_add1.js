      ...
      if (newRecord) {
        newRecord.addEventListener('click', function () {
          ...
          (offCanvasElement.querySelector('.dt-avenues-name').value = ''),
            ...
            (offCanvasElement.querySelector('.dt-floors-name').value = ''),
            (offCanvasElement.querySelector('.dt-floors-plan').value = ''),
            (offCanvasElement.querySelector('.dt-floors-solt-price').value = '');
...
$(function () {
  ...
  if (dt_basic_table.length) {
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Floors Details</h5>');
  }
